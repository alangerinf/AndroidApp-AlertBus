...
public class AdapterDialogMapa {

    private Dialog dialogMap;
    private Context ctx;
    private static String TAG = AdapterDialogMapa.class.getSimpleName();
    ...
    public AdapterDialogMapa(Context ctx, Double latIni,Double lonIni,Double latFin,Double lonFin) {
    ...
    private void declare(){
        dialogMap.setContentView(R.layout.dialog_map_viaje);
