...
public class Utilities {
    ...
    public static final String URL_ROOT="http://35.167.15.182/APIs/AlertBus/Ecosac/Requests/";
    //public static final String URL_ROOT="http://35.167.15.182/APIs/AlertBus/Demo/Requests/";
    //public static final String URL_ROOT="http://35.167.15.182/APIs/AlertBus/Hass/Requests/";
    ...
    public static final String URL_BUSCARRESTRICCIONES=URL_ROOT+"exec_sql.php";
    ...
    public static final String TABLE_LOGINDATA="loginData",
            ...
            TABLE_LOGINDATA_COL_TRANQUERA       ="tranquera",
            TABLE_LOGINDATA_TYPECOL_TRANQUERA   ="INTEGER";
    ...
    public static final String TABLE_VIAJE ="viaje",
            ...
            TABLE_VIAJE_COL_EMPRESA           ="empresa",
            TABLE_VIAJE_TYPECOL_EMPRESA       ="VARCHAR(50)",
            ...
            TABLE_VIAJE_TYPECOL_COMENTARIO      ="VARCHAR(5000)",
    ...
    public static final String CREATE_TABLE_VIAJE =
            " CREATE TABLE IF NOT EXISTS "+ TABLE_VIAJE +" ("+
                    ...
                    TABLE_VIAJE_COL_EMPRESA       +" "+TABLE_VIAJE_TYPECOL_EMPRESA +" , "+
    ...
    public static final String CREATE_TABLE_LOGINDATA =
            " CREATE TABLE IF NOT EXISTS "+TABLE_LOGINDATA+" (" +
                    ...
                    TABLE_LOGINDATA_COL_TRANQUERA+" "+TABLE_LOGINDATA_TYPECOL_TRANQUERA+" "+
                    ")";
