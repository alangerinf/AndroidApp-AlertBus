...
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_IDUSER;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_IDVIAJE;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_LASTNAME;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_NAME;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_PASSWORD;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_TRANQUERA;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_TYPEUSER;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_LOGINDATA_COL_USER;
...
public class LoginDataDAO {
    ...
    public int guardarUsuarioNuevo(LoginDataVO loginDataVO){
     ...
     //   Log.d(TAG,loginDataVO.getName()+" >-< "+loginDataVO.getListIdTipoProcesos());
        ...
        ContentValues values = new ContentValues();
            ...
            values.put(TABLE_LOGINDATA_COL_TRANQUERA,loginDataVO.getIsTranquera());
        ...
        try{
            Cursor cursor = db.rawQuery(
                    "SELECT " +
                            ...
                            "LD."+TABLE_LOGINDATA_COL_TRANQUERA+" "+//6
                            " FROM "+
            ...
            if(cursor.getCount()>0){
               ...
               // Log.d(TAG,"3");
                ...
                temp.setTranquera(cursor.getInt(7));
            }
            cursor.close();
    ...
    public void deleteIdViaje(int  idViaje){
        //   Log.d(TAG,loginDataVO.toString());
        ...
        ContentValues values = new ContentValues();
        values.put(TABLE_LOGINDATA_COL_IDVIAJE,0);
        int id = (int)db.update(TABLE_LOGINDATA,values,null,null);
        db.close();
        c.close();
