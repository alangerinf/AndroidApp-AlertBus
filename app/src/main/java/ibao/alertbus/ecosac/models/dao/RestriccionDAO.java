...
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_RESTRICCION_COL_DESC;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_RESTRICCION_COL_ID;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_RESTRICCION_COL_IDVIAJE;
import static ibao.alertbus.ecosac.utilities.Utilities.TABLE_RESTRICCION_COL_NAME;
...
public class RestriccionDAO {
    ...
    public boolean insertar2( String rfid, String dni, String restriccion){
        ...
        try {
            ...
            db.insert("TrabajadorRestriccion",null, values);
            db.close();
            conn.close();
            return true;
        }catch (Exception e){
    ...
    public void deleteAll() {
        ConexionSQLiteHelper conn=new ConexionSQLiteHelper(ctx, DATABASE_NAME,null,VERSION_DB);
        SQLiteDatabase db = conn.getWritableDatabase();
        db.delete("TrabajadorRestriccion", null, null);
        db.close();
        conn.close();
    }
}
