...
import ibao.alertbus.ecosac.views.DetailActivity;
import ibao.alertbus.ecosac.views.RestricionActivity;

public class RViewAdapterListViajesSupervisor extends RecyclerView.Adapter<RViewAdapterListViajesSupervisor.ViewHolder>  {
    ...
    final private String TAG = RViewAdapterListViajesSupervisor.class.getSimpleName();

    public RViewAdapterListViajesSupervisor(Context ctx, List<ViajeVO> viajeVOList, RecyclerView recyclerView) {
        this.ctx = ctx;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_viajesupervisor_detail,viewGroup,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int pos) {
        ...
        float porc = (float) (viajeVO.getNumPasajerosRegistrados() * 100)/viajeVO.getCapacidad();
